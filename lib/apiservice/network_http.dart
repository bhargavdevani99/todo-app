...
import 'package:loan_bazzar/config/api_string.dart';
import 'package:loan_bazzar/config/local_storage.dart';
import 'package:loan_bazzar/controllers/auth_controller.dart';
import 'package:loan_bazzar/utils/shared_preference/shared_preference_services.dart';
import 'package:loan_bazzar/view/auth/login_screen.dart';
import 'package:loan_bazzar/widget/common_snackbar.dart';
...
class HttpHandler {
  ...
  static Map<String, dynamic> handler(http.Response response) {
    ...
    if (response.statusCode == 200) {
      ...
      clearLocalStorage();
      if (!Get.find<AuthController>().isSnackbarShown.value) {
        Get.offAll(() => const LoginScreen());
        showSnackbar(title: "Warning", message: "Session Expire");
        Get.find<AuthController>().isSnackbarShown.value = true;
      }
      // if(Get.find<AuthController>().isLogin.value == false) {
      //   Get.offAll(() => const LoginScreen());
      //   showSnackbar(title: "Warning", message: "Session Expire");
      // }
      return {
